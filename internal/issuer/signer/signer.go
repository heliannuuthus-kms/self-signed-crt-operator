...
type SignerBuilder func(*piv1alpha1api.IssuerSpec, map[string][]byte) (Signer, error)
...
func ExampleSignerFromIssuerAndSecretData(*piv1alpha1api.IssuerSpec, map[string][]byte) (Signer, error) {
	return &exampleSigner{}, nil
}
